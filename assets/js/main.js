...
document.querySelectorAll(".question").forEach((question) => {
    question.addEventListener("click", function () {
      console.log("Question clicked"); // Check if the click event is registered
  
      const parent = this.closest(".question_answer");
      const isActive = parent.classList.contains("active");
  
      document.querySelectorAll(".question_answer").forEach((qa) => qa.classList.remove("active"));
